...
const Dashboard : React.FC = () => {
  ...
  const productsData = {
    labels: summary.productsData.map((x: { _count : { id: number}}) => x._count.id),
    datasets: [
      {
        label: 'Category',
        data: summary.productsData.map(
          (x: { _count : { id: number}}) => x._count.id,
        ),
        backgroundColor: [
          'rgba(255, 99, 132, 0.2)',
          'rgba(54, 162, 235, 0.2)',
  ...
  const usersData = {
    labels: summary.usersData.map((x: { id: string }) => x.id),
    datasets: [
      {
        label: 'Users',
        borderColor: 'rgb(53, 162, 235)',
    ...
    <div>
      <div className='stats stats-vertical my-4 inline-grid shadow md:stats-horizontal md:flex'>
        <div className='stat'>
          ...
          <div className='font-semibold text-2xl text-primary'>
            {formatRupiah(summary.ordersPrice)}
          </div>
        ...
        <div className='stat'>
          ...
          <div className='font-semibold text-2xl text-primary'>{summary.ordersCount}</div>
          <div className='stat-desc'>
        ...
        <div className='stat'>
          ...
          <div className='font-semibold text-2xl text-primary'>{summary.productsCount}</div>
          <div className='stat-desc'>
        ...
        <div className='stat'>
          ...
          <div className='font-semibold text-2xl text-primary'>{summary.usersCount}</div>
          <div className='stat-desc'>
      ...
      <div className='grid gap-4 md:grid-cols-2'>
        <div>
          ...
          <div className='h-80 w-96 items-center justify-center '>
